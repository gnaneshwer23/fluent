    ...
    return (
        <div className="min-h-screen bg-slate-50 p-8">
            <header className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-2xl font-serif font-bold text-fluent-navy">Admin Dashboard</h1>
                    <p className="text-sm text-slate-500">Platform overview & management</p>
                </div>
                ...
                {tab === "schools" && (
                    <Card>
                        ...
                        <table className="w-full text-sm">
                            <thead className="text-left text-gray-500 uppercase text-[10px] tracking-widest">
